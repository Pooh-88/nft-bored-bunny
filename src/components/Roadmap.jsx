        ...
        <div className="steps text-neutral-100 py-10 flex flex-col gap-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 skew-y-2">
            ...
            <div className="md:border-l-2 pl-3 pr-1 py-3 rounded-3xl min-h-[150px] flex flex-col items-center justify-center">
              ...
              <p className=' leading-7 text-lg text-neutral-300'>We will release our first merch collection of Magic Dog that will be available only for the holder. To celebrate the achievement of our goals, we are to organize a party for our holders, the community choose the location</p>
            </div>
          </div>
          </Fade>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 -skew-y-2">
            ...
            <div className="md:border-r-2 pr-3 pl-1 py-3 rounded-3xl min-h-[150px] flex flex-col items-center justify-center">
              ...
              <p className=' leading-7 text-lg text-neutral-300'>We are committed to support, invest, reward, and collaborate with the best projects in the space and projects ideas of our members. You'll need a total of 2 Magic Dog to breed your Magic Dog, to get a 2nd Generation Magic Dog.</p>
            </div>
          </div>
          </Fade>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 skew-y-2">
            ...
            <div className="md:border-l-2 pl-3 pr-1 py-3 rounded-3xl min-h-[150px] flex flex-col items-center justify-center">
              <h3 className='text-3xl mb-2'>#4 Magic Dog City</h3>
              <p className=' leading-7 text-lg text-neutral-300'>We are planning to buy some land for our Community The Magic Dog community will have access to private events in the Metaverse.</p>
            </div>
          </div>
          </Fade>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 -skew-y-2">
            ...
            <div className="md:border-r-2 pr-3 pl-1 py-3 rounded-3xl min-h-[150px] flex flex-col items-center justify-center">
              <h3 className='text-3xl mb-2'>#5 Magic Dog Over The World</h3>
              <p className=' leading-7 text-lg text-neutral-300'>We want to show you that you made the best choice to join Magic Dog and make sure that your investment is profitable. To do so we are planning to do massive marketing (well known celebrities, Ads in the biggest cities in the world ...)</p>
            </div>
          </div>
          </Fade>
